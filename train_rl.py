...
class MainConfig(common_utils.RunConfig):
    ...
    is_demo: bool = True    # To shift between the actual demos and sketch generated demos
    # (sketch generated demos may/may not have rewards)
...
def main():
    ...
    cfg.save_dir = f"/fs/nexus-projects/Sketch_VLM_RL/amishab/IBRL_robomimic_sketch/can_seed{cfg.seed}"
