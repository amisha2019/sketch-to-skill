...
BC_POLICIES = {
    "Assembly": "/fs/nexus-projects/Sketch_VLM_RL/amishab/BC_sketch_RL/BC_demo3_gen_10/Assembly_epoch20_seed0/model0.pt",
    "BoxClose": "/fs/nexus-projects/Sketch_VLM_RL/amishab/BC_sketch_state_gen1/BoxClose_epoch2_seed4/model1.pt",
    # "CoffeePush": "/fs/nexus-projects/Sketch_VLM_RL/amishab/BC_sketch_state_gen1/CoffeePush_epoch2_seed1/model1.pt",
    "ButtonPress": "/fs/nexus-projects/Sketch_VLM_RL/amishab/BC_sketch_state_gen1/ButtonPress_epoch2_seed1/model1.pt",
    "ButtonPressTopdownWall": "/fs/nexus-projects/Sketch_VLM_RL/amishab/BC_sketch_state_gen1/ButtonPressTopdownWall_epoch2_seed2/model1.pt",
    "Reach": "/fs/nexus-projects/Sketch_VLM_RL/amishab/BC_sketch_state_gen1/Reach_epoch2_seed2/model1.pt",
    "DrawerOpen": "/fs/nexus-projects/Sketch_VLM_RL/amishab/BC_sketch_state_gen1/DrawerOpen_epoch2_seed2/model1.pt",
    "ReachWall": "/fs/nexus-projects/Sketch_VLM_RL/amishab/BC_sketch_state_gen1/ReachWall_epoch2_seed2/model1.pt",

    ####################State#################
    # "ButtonPress": "/fs/nexus-projects/Sketch_VLM_RL/amishab/BC_IBRL_96_demo3/ButtonPress_epoch2_seed0_obj/model1.pt",
    #####original
    # "CoffeePush":'/fs/nexus-projects/Sketch_VLM_RL/amishab/BC_IBRL_96_demo3/CoffeePush_epoch2_seed1/model1.pt',
    # "Assembly": "/fs/nexus-projects/Sketch_VLM_RL/amishab/BC_IBRL_state_demo3/Assembly_epoch2_seed1/model0.pt",
    # "BoxClose": "/fs/nexus-projects/Sketch_VLM_RL/amishab/BC_IBRL_state_demo3/BoxClose_epoch2_seed1/model0.pt",
    # "ButtonPress": "/fs/nexus-projects/Sketch_VLM_RL/amishab/BC_IBRL_state_demo3/ButtonPress_epoch2_seed1/model0.pt",
    # "DrawerOpen": "/fs/nexus-projects/Sketch_VLM_RL/amishab/BC_IBRL_state_demo3/DrawerOpen_epoch2_seed1/model0.pt",
    # "Reach": "/fs/nexus-projects/Sketch_VLM_RL/amishab/BC_IBRL_state_demo3/Reach_epoch2_seed1/model0.pt",
    # "ReachWall": "/fs/nexus-projects/Sketch_VLM_RL/amishab/BC_IBRL_state_demo3/ReachWall_epoch2_seed1/model0.pt",
    # "ButtonPressTopdownWall": "/fs/nexus-projects/Sketch_VLM_RL/amishab/BC_IBRL_state_demo3/ButtonPressTopdownWall_epoch2_seed1/model0.pt",
}
...
####Sketch##################
    "BoxClose": "/fs/nexus-projects/Sketch_VLM_RL/teacher_model/peihong/raw_demo_servoring_data/BoxClose/BoxClose_teachermodel_gen_1.hdf5",
    ...
    "DrawerOpen": "/fs/nexus-projects/Sketch_VLM_RL/teacher_model/peihong/raw_demo_servoring_data/DrawerOpen/DrawerOpen_teachermodel_gen_1.hdf5",
    "Reach": "/fs/nexus-projects/Sketch_VLM_RL/teacher_model/peihong/raw_demo_servoring_data/Reach/Reach_teachermodel_gen_1.hdf5",
    ...
    "ReachWall": "/fs/nexus-projects/Sketch_VLM_RL/teacher_model/peihong/raw_demo_servoring_data/ReachWall/ReachWall_teachermodel_gen_1.hdf5",
    "ButtonPressTopdownWall": "/fs/nexus-projects/Sketch_VLM_RL/teacher_model/peihong/raw_demo_servoring_data/ButtonPressTopdownWall/ButtonPressTopdownWall_teachermodel_gen_1.hdf5",
}
...
class Workspace:
    def __init__(self, cfg: MainConfig):
        ...
        print("cfg.bc_policy", cfg.bc_policy)
        ...
        # bc_policy, _, self.env_params = train_bc_state.load_model(cfg.bc_policy, "cuda")
    ...
    def _setup_env(self):
        ...
        self.env_params["rl_image_size"] = 96
...
def load_model(weight_file, device):
    ...
    if cfg.bc_policy:
        # bc_policy, _, _ = train_bc_state.load_model(cfg.bc_policy, device)
...
if __name__ == "__main__":
    ...
    # cfg.save_dir = f"/fs/nexus-projects/Sketch_VLM_RL/amishab/IBRL/{cfg.bc_policy}_seed{cfg.seed}"
    cfg.save_dir = f"/fs/nexus-projects/Sketch_VLM_RL/amishab/IBRL_teachermodel_demo3_gen_10/{cfg.bc_policy}_seed{cfg.seed}"
    # cfg.save_dir = f"/fs/nexus-projects/Sketch_VLM_RL/amishab/IBRL/{cfg.dataset.task_name}_epoch{cfg.num_epoch}_seed{cfg.seed}"
