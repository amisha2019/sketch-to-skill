...
class MainConfig(common_utils.RunConfig):
    ...
    # log
    use_wb: int = 0
    save_dir: str = "/fs/nexus-projects/Sketch_VLM_RL/amishab/BC_sketch_RL/BC_demo3_gen_10/Assembly_epoch20_seed0"
...
if __name__ == "__main__":
    ...
    dataset = MetaWorldDataset(cfg.dataset)
    cfg.task_name = dataset.task_name
    cfg.save_dir =f"/fs/nexus-projects/Sketch_VLM_RL/amishab/BC_sketch_RL/BC_demo3_gen_10/{cfg.dataset.task_name}_epoch{cfg.num_epoch}_seed{cfg.seed}"
