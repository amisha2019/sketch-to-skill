...
BC_POLICIES = {
    "Assembly": "/fs/nexus-projects/Sketch_VLM_RL/amishab/BC_demo3_gen_10/Assembly_epoch2_seed1/model1.pt",
...
if __name__ == "__main__":
    ...
    cfg.save_dir = f"/fs/nexus-projects/Sketch_VLM_RL/amishab/RL_discriminator/{cfg.bc_policy}_seed{cfg.seed}"
