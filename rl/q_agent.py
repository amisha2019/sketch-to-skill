...
class QAgent(nn.Module):
    ...
    def _act_ibrl(
        ...
        *,
        ...
        # Add extra gripper action - RL Sketch
        # bc_action = torch.cat([bc_action, torch.zeros(bc_action.size(0), 1, device=bc_action.device)], dim=1)
        # print(f"Current BC action: {bc_action.shape}")  
