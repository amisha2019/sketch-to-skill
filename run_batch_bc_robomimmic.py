...
root_dir = "/fs/nexus-projects/Sketch_VLM_RL/amishab/BC_robomimic_sketch/"
...
for seed in seeds:
    ...
    python_command = (
        f"python train_bc.py "
        f"--config_path release/cfgs/robomimic_bc/can.yaml "
        f"--dataset.num_data 200 "
        f"--num_epoch 200 "
        f"--seed {seed} "
        f"--use_wb 0"
    )
